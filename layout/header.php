<div class="container-fluid">
        <div class="row soid" style="height: 40px;; margin-top: 7px;" id="footer">
            <div class="col-md-3">               
                <h6><i class="fa fa-phone"></i>  Phone: (090) 0922299818; (090) 863954</h6>       
            </div>
            <div class="col-md-3">
                <h6> <i class="fa fa-clock-o" aria-hidden="true"></i>  We are open: Mn-Fr: 8am - 10pm </h6>       
            </div>
            <div class="col-md-3">
                <h6 style="margin-left: 270px;"><a href="#">Đánh giá</a></h6>
            </div>
            <div class="col-md-1">
                <h6 style="margin-left: 25px;"><a href="#">Góp ý</a></h6>
            </div>
            <div class="col-md-1">
                <h6><a href="dangnhap.php">Đăng nhập</a></h6>
            </div>
            <div class="col-md-1">
                <h6><a href="dangky.php">Đăng ký</a></h6>
            </div>
        </div>
        <div class="row soid ">
        ...
        <div class=" row soid" style="padding-top: 20px;">
            <div id="menu" class="col-md-9" style="height: 50px;">
                <ul>
                    <li class="bg_MENU_mg">
